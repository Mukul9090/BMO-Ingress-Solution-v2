...
kubectl apply -f k8s/cluster-hot/namespace.yaml
echo "✓ Namespace created"

echo "Creating ConfigMap..."
kubectl apply -f k8s/cluster-hot/configmap.yaml
echo "✓ ConfigMap created"

echo "Creating Deployment..."
kubectl apply -f k8s/cluster-hot/deployment.yaml
echo "✓ Deployment created"

echo "Creating Service (ClusterIP)..."
kubectl apply -f k8s/cluster-hot/service.yaml
...
if [ "${CREATE_NODEPORT:-false}" = "true" ]; then
    ...
    kubectl apply -f k8s/cluster-hot/service-nodeport.yaml
